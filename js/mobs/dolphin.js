 ...
 * model.js para el formato de las partes y el desplegado UV; pig.js es el
...
export default {
    ...
    sonidos: {
        // say: chillidos de superficie idle1-6; water/idle (versión sumergida)
        // se omite porque el motor solo tiene un evento say y iría de fallback muerto.
        say: ['mob/dolphin/idle'],
