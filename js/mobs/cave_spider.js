 ...
 *
 * Modelo: copia del patrón de spider.js a escala 70 %. Abdomen atrás (+Z) y
...
export default {
    ...
    /** Voces reales del pack: comparte carpeta con spider (say1-4, death; sin hurt). */
    sonidos: {
        say: ['mob/spider/say'],
        // la carpeta no trae hurt: el siseo de say es el sonido de daño canónico
        hurt: ['mob/spider/say'],
