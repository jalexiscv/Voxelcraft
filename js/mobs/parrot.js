 ...
 * partes y el desplegado UV; pig.js es el ejemplo canónico del contrato).
 *
...
export default {
    ...
    // Voces del pack local: idle es el graznido ambiente del loro (say).
    sonidos: {
        say: ['mob/parrot/idle'],
        hurt: ['mob/parrot/hurt'],
        death: ['mob/parrot/death'],
    },
};
