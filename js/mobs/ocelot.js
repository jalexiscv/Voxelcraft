 ...
 * pig.js es el ejemplo canónico del contrato).
 *
...
export default {
    ...
    /** Voces del pack local (mob/cat/ocelot; hurt no existe ahí y se toma del gato). */
    sonidos: {
        say: ['mob/cat/ocelot/idle'],
        hurt: ['mob/cat/hitt'],
        death: ['mob/cat/ocelot/death'],
    },
};
