...
export default {
    ...
    /** Voces reales del pack: cada prefijo absorbe también su variante *_land
     *  (gorgoteo sumergido + gruñido en superficie), variedad deseable porque
     *  el motor no distingue el medio al vocalizar. */
    sonidos: {
        say: ['mob/zombie_nautilus/ambient'],
