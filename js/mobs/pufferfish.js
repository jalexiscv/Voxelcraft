 ...
 * y el desplegado UV; pig.js es el ejemplo canónico; mobs.js para el
 * comportamiento).
 *
...
export default {
    ...
    /** Voces reales del pack (carpeta compartida de peces, igual que cod). */
    sonidos: {
        // sin vocalización propia: el burbujeo de nado hace de ambiente acuático
        say: ['mob/fish/swim'],
        hurt: ['mob/fish/hurt'],
        // los peces no tienen death en el pack: reutilizan hurt (canónico del juego)
        death: ['mob/fish/hurt'],
    },
};
