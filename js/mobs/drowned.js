...
export default {
    ...
    // botín: carne podrida macerada por el agua, como todo zombi; muy rara
    // vez suelta la hortaliza que llevaba encima (fuente inicial de cultivos)
    drops: [
    ...
    /** Voces del paquete local (prefijos bajo sounds/, ver soundpack.js). */
    sonidos: {
        // ambiente: gemido burbujeante sumergido (water/idle), fiel al gorgoteo
        // del sintetizador; el gemido en seco (idle) queda como respaldo
        say: ['mob/drowned/water/idle', 'mob/drowned/idle'],
