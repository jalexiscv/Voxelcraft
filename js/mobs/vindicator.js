...
export default {
    ...
    /** Voces reales del pack local (celebrate se omite: sin evento equivalente). */
    sonidos: {
        say: ['mob/vindication_illager/idle'],
        hurt: ['mob/vindication_illager/hurt'],
        death: ['mob/vindication_illager/death'],
    },
};
