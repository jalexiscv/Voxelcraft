...
export default {
    ...
    /** Voces reales del pack (estado sin oxidar); «look» es su vocalización ambiente. */
    sonidos: {
        say: ['mob/copper_golem/regular/look'],
        hurt: ['mob/copper_golem/regular/hurt'],
        death: ['mob/copper_golem/regular/death'],
    },
};
