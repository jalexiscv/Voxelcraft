 ...
 * y el desplegado UV; pig.js es el ejemplo canónico del contrato).
 *
...
export default {
    ...
    // Voces reales del pack (mob/fish, compartida por todos los peces): sin
    // «say» porque los peces no vocalizan (flop/swim son movimiento, no voz);
    // como en vanilla, el quejido de daño cubre también la muerte.
    sonidos: {
        hurt: ['mob/fish/hurt'],
        death: ['mob/fish/hurt'],
    },
