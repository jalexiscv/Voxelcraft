...
export default {
    ...
    // say=squish: el chapoteo gomoso al desplazarse es su vocalización ambiente
    // (bounce es más bien un impacto contra el suelo).
    sonidos: {
        say: ['mob/sulfur_cube/squish'],
        hurt: ['mob/sulfur_cube/hit'],
